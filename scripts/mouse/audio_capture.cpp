...
bool capture_on(std_srvs::Empty::Request &req,
...
bool capture_off(std_srvs::Empty::Request &req,
		 std_srvs::Empty::Response &res)
{
  is_capture = false;
  return true;
...
namespace audio_transport
{
  class RosGstCapture
  {
	...
	//additional code by iwawo.
	_serv_on = _nh.advertiseService("audio_capture/on", capture_on);
	_serv_off = _nh.advertiseService("audio_capture/off", capture_off);
    ...
    ros::NodeHandle _nh;
    ros::Publisher _pub;
    ros::ServiceServer _serv_on;
    ros::ServiceServer _serv_off;
